    ...
    >
      ...
      <div className="flex items-center gap-2 pl-3">
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-medium text-[13px] tracking-tight text-on-surface/80">tunaChat</span>
        </div>
        ...
        <button
          onClick={() => useSystemStore.getState().setSettingsOpen(!useSystemStore.getState().settingsOpen)}
          className="text-on-surface-variant/50 hover:text-on-surface transition-colors flex items-center justify-center size-7 rounded hover:bg-white/5"
          title="설정"
        >
          <GearSix size={14} />
        </button>
